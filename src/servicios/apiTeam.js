...
export const TeamAPI = {
   ...
   */
  async createInvitation({ email, scopes, scopeType, scopeId, role, alias, sectorIds }) {
    return http('/team/invitations', {
      method: 'POST',
      body: scopes
        ? { email, scopes, role, alias, sectorIds }
        : { email, scopeType, scopeId, role, alias, sectorIds },
